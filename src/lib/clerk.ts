...
/**
 * Clerk config. The publishable key is public by design (shared with iOS + web +
 * backend — see the vault). Dev instance direct-hippo-38; the Pi backend verifies
 * session JWTs against the same instance's JWKS.
 *
...
export const CLERK_PUBLISHABLE_KEY =
  'pk_test_ZGlyZWN0LWhpcHBvLTM4LmNsZXJrLmFjY291bnRzLmRldiQ';
