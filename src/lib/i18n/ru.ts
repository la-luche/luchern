...
export const ru: Dict = {
  ...
  invite: {
    ...
    enterButton: 'Enter a doctor’s code',
    enterPrompt: 'Enter the 4-digit code from your doctor.',
    codePlaceholder: '0000',
    yourDoctor: 'your doctor',
    confirmTitle: (name: string) => `Link with ${name}?`,
    confirmBody: 'They’ll be able to see your recordings and results.',
    allow: 'Allow',
    linkedTitle: 'You’re connected',
    linkedBody: (name: string) => `${name} can now see your recordings.`,
    done: 'Done',
    tryAgain: 'Try again',
    errors: {
