...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "boxes": {
        ...
        "face": {
            ...
            "top_body_fallback": False,
            "shoulder_confidence": 0.10,
        },
        "reliability_gate": {
            "enabled": False,
            "window_seconds": 0.5,
            "visible_confidence": 0.5,
            "minimum_median_visible_joints": 5,
            "jump_confidence": 0.15,
            "maximum_residual_jump_p90": 0.25,
        },
    },
    "interpolation": {
        "mode": "strict",
...
NUMERIC_RULES: dict[tuple[str, ...], tuple[float, float, type]] = {
    ...
    ("boxes", "reliability_gate", "window_seconds"): (0.1, 10, float),
    ("boxes", "reliability_gate", "visible_confidence"): (0, 1, float),
    ("boxes", "reliability_gate", "minimum_median_visible_joints"): (1, 33, int),
    ("boxes", "reliability_gate", "jump_confidence"): (0, 1, float),
    ("boxes", "reliability_gate", "maximum_residual_jump_p90"): (0, 10, float),
...
BOOLEAN_PATHS = {
    ...
    ("boxes", "reliability_gate", "enabled"),
